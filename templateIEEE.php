    ...
    // buat variable sesuai data dari array database
        // 1. mengambil nama (value type => string)
            ...
            // == nama column dari database testing table IEEE
                foreach (array_keys($all_databases[$nm_db_testing][$nm_table_IEEE]) as $nama_column) {
        ...
        // 2. mengambil value
            ...
            // == string value dari nm_table_IEEE sesuai nama_column-nya
                foreach ($all_databases[$nm_db_testing][$nm_table_IEEE] as $nama_column => $value) {
        ...
        <div class="row">
                ...
                <form action="" method="post">
                    <table border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                            ...
                            <td class="col2"><input type="date" name="<?= $nm_table_date; ?>" required class="title" value=<?= date('Y-m-d'); ?> /></td>
                        </tr>
                        <!-- title -->
                        <tr>
                            <td class="col1">Title</td>
                            <td class="col2"><input type="text" name="<?= $nm_column_title; ?>" required class="title"></td>
                        </tr>
                        <!-- abstract -->
                        <tr>
                            <td class="col1" valign="top">Background</td>
                            <td class="col2"><textarea name="<?= $nm_table_background; ?>" required class="content"></textarea></td>
                        </tr>
                        <tr>
                            <td class=" col1"></td>
            ...
            <div class="col-6 border">
                ...
                if (
                    ...
                    // saluran
                    $replace_saluran_base         = [ $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_saluran] ];
                    ...
                    // title
                    $replace_title_base        = [ $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_title] ];
                    ...
                    // background
                    $replace_background_base         = $all_databases[$nm_db_testing][$nm_table_background];
                    ...
                    $get_description = $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_description];
                    $get_acaraTV1    = $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_acaraTV1];
                    $get_acaraTV2    = $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_acaraTV2];
                    $get_acaraTV3    = $replace_title_string;
                    $get_link        = $all_databases[$nm_db_testing][$nm_table_IEEE][$nm_column_link];
